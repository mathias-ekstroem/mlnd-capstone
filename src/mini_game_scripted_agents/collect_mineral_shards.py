...
class CollectMineralShardsRandomAgent(base_agent.BaseAgent):

    def __init__(self):
        super(CollectMineralShardsRandomAgent, self).__init__()
        self.score = None

    def step(self, obs):
        super(CollectMineralShardsRandomAgent, self).step(obs)
